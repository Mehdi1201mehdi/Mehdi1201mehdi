...
const CACHE = "coachperso-ia-v7";
const MEDIA_CACHE = "coachperso-media-v1";
const MEDIA_HOSTS = ["exercisedb.dev", "exercisedb.p.rapidapi.com", "workoutxapp.com", "wger.de", "cloudfront.net", "vercel"];
const ASSETS = [
  "./", "./index.html", "./style.css", "./manifest.webmanifest", "./assets/icons/icon.svg",
  "./src/ui/app.js", "./src/ui/anatomy.js", "./src/models.js",
  "./src/data/exercises.js", "./src/data/exercises-extra.js", "./src/data/foods.js",
